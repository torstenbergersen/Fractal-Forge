...
export default function Home() {
  return (
    <main className="w-screen h-screen overflow-hidden relative">
      ...
      {/* Footer */}
      <footer className="absolute bottom-0 left-0 right-0 bg-black bg-opacity-50 text-white p-2 flex justify-center items-center">
        <p className="mr-2">torstenbergersen</p>
        <a
          href="https://github.com/torstenbergersen"
          target="_blank"
